...
import ListToolScreen from "../Entities/Tool/List.tool.screen";
import ShowToolScreen from "../Entities/Tool/Show.tool.screen";
  ...
  return (
    <Stack.Navigator {...stackrops}>
      ...
      />
        ...
        <Stack.Screen
            name="ListToolScreen"
            component={ListToolScreen}
            options={screenOptions}
          />
          <Stack.Screen
          name="ShowToolScreen"
          component={ShowToolScreen}
          options={screenOptions}
        />
